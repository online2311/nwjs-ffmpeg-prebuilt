...
FROM alpine:latest
COPY --from=builder /nwjs-ffmpeg-prebuilt/nwjs-v0.54.1-linux-arm64.zip .
COPY --from=builder /nwjs-ffmpeg-prebuilt/nwjs-v0.54.1-linux-arm.zip .
COPY --from=builder /nwjs-ffmpeg-prebuilt/nwjs-v0.54.1-linux-x64.zip .
COPY --from=builder /nwjs-ffmpeg-prebuilt/nwjs-v0.54.1-win-x64.zip .
